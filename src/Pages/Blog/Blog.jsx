    ...
    <div className="container pt-28 mx-auto p-3">
      ...
      <div className=" md:grid grid-cols-3 my-5 gap-5 ">
        <div className="bg-[#ededed] p-5 rounded-md shadow-lg">
          ...
          <p>জনপ্রিয় স্ক্র্যাচ প্ল্যাটফর্মে এখন থেকে বাংলা ভাষাতেই প্রোগ্রামিং ও প্রজেক্ট করা যাবে। বিশ্বের ১৯০টি দেশের শিশু-কিশোরদের প্রোগ্রামিং শেখার...... <Link to="/details" className="link link-hover text-violet-600">Read more</Link></p>
        </div>
        <div className="bg-[#ededed] p-5 rounded-md shadow-lg">
          <div className="avatar">
            <div className="w-fit rounded">
