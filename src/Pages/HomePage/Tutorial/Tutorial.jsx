...
const Tutorial = () => {
  ...
  return (
    <div className="items-center grid-cols-2 gap-16 md:grid p-3 container pt-14 mx-auto">
      <div className="">
        <iframe width="100%" height="300" src="https://www.youtube.com/embed/Bs4bNZRo28Q?si=EahUPgogqkpxl7nI" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
